# tiny11builder (forked)
Scripts to build a trimmed-down Windows 11 image - now in **PowerShell**!

---
### Why the fork?

This project includes some open PRs from people that I deemed useful to include for my own personal use.
...
Alternative, just run Run.bat to do this for you.
...
2. Run the script and select the path name of the image you just downloaded (i.e. `C:\Users\User\Downloads\Win11.iso`)
